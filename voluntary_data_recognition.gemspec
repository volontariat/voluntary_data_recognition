...
Gem::Specification.new do |s|
  ...
  s.summary     = 'Data recognition plugin for Crowdsourcing management system Voluntary.Software.'
  s.description = 'Plugin for #Crowdsourcing system Voluntary.Software: http://bit.ly/vdr-0-0-1'
  s.license     = 'MIT'

  s.files = Dir['{app,config,db,lib}/**/*', 'MIT-LICENSE', 'Rakefile', 'README.rdoc']

  s.add_dependency 'voluntary', '~> 0.7'
  s.add_dependency 'voluntary_survey', '~> 0.1'
